			...
			<div>
				...
				<div className="container">
	                ...
	                <div className="col-lg-6 col-md-6  col-sm-12">
					   ...
					   <p>We also can help minimize the level of mosquitoes on your property. Along with the itchy red spots that these annoying little insects can cause, they also are known to carry viruses such as the Zika Virus and West Nile Virus.
