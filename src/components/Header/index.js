                    ...
                    <div className="container">
                        ...
                        <div className="navbar-collapse collapse" >
                            <ul className="nav navbar-nav navbar-right">
                                ...
                                <li><a href="https://app.acuityscheduling.com/schedule.php?owner=13546773">SCHEDULE<i className="fa fa-folder-open-o"></i><span>Schedule an appointment today</span></a></li>
                                <a 
